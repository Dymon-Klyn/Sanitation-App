...
def move_data(data, event, old, new):
    ...
    try:
        ...
        ctypes.windll.user32.MessageBoxW(0,"Sorry, there is no task to remove.","Error Prevention", 0)
...
def create():
    ...
    while answer=="":
        ...
        #input validation to make sure string is not empty
        ctypes.windll.user32.MessageBoxW(0,"Please enter a name for your task!","Input Validation", 0)
